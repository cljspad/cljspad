...
var G__32958 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__32958__$1 = (((G__32958 == null))?null:cljs.core.iterate((function (loc){
...
var G__32958__$2 = (((G__32958__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__32958__$1));
var G__32958__$3 = (((G__32958__$2 == null))?null:cljs.core.last(G__32958__$2));
if((G__32958__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__32958__$3);
}
} else {
return zloc;
}
...
var G__32961 = rewrite_clj.zip.move.right(v);
var G__32962 = rewrite_clj.zip.move.up(v);
loc = G__32961;
parent = G__32962;
continue;
} else {
var G__32963 = rewrite_clj.zip.move.right(v0);
var G__32964 = parent;
loc = G__32963;
parent = G__32964;
continue;
...
var G__32965 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__32966 = rewrite_clj.zip.move.up(v);
loc = G__32965;
parent = G__32966;
continue;
} else {
var G__32967 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__32968 = parent;
loc = G__32967;
parent = G__32968;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__32959 = zloc;
var G__32959__$1 = (((G__32959 == null))?null:rewrite_clj.zip.move.down(G__32959));
var G__32959__$2 = (((G__32959__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__32959__$1,k));
if((G__32959__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__32959__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__32960 = rewrite_clj.zip.move.down(zloc);
var G__32960__$1 = (((G__32960 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__32960));
if((G__32960__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__32960__$1);
}
})(),k);
}
});
