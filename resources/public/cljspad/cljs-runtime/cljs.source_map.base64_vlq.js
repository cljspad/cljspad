...
var digit_25876 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_25877__$1 = (vlq >>> (5));
while(true){
if((vlq_25877__$1 > (0))){
var digit_25878__$1 = (digit_25876 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_25878__$1));

var G__25880 = (vlq_25877__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__25881 = (vlq_25877__$1 >>> (5));
digit_25876 = G__25880;
vlq_25877__$1 = G__25881;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_25876));
}
break;
}
...
var G__25884 = i__$1;
var G__25885 = result__$1;
var G__25886 = shift__$1;
i = G__25884;
result = G__25885;
shift = G__25886;
continue;
