...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__29620_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29620_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__29620_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__29621){
var vec__29622 = p__29621;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29622,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29622,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__29625,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29626__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29626__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29626__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__29630 = (function (){var or__4126__auto__ = color;
...
var fexpr__29629 = (function (){var G__29631 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__29631) : style_map.call(null,G__29631));
})();
return (fexpr__29629.cljs$core$IFn$_invoke$arity$1 ? fexpr__29629.cljs$core$IFn$_invoke$arity$1(G__29630) : fexpr__29629.call(null,G__29630));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__29636){
var vec__29637 = p__29636;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29637,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29637,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29637,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__29642){
var vec__29643 = p__29642;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29643,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29643,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29643,(2),null);
...
var G__29789 = cljs.core.next(ssv);
var G__29790 = (this_ssv == null);
var G__29791 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__29792 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__29789;
doing_nil_QMARK_ = G__29790;
last_elide = G__29791;
out = G__29792;
continue;
}
...
var vec__29653 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29653,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29653,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29653,(2),null);
...
var G__29797 = cljs.core.next(remaining_cvec);
var G__29798 = new_idx;
var G__29799 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__29797;
idx = G__29798;
out = G__29799;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__29678,cursor_vec){
var vec__29679 = p__29678;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29679,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29679,(1),null);
var focus_vec = vec__29679;
...
var vec__29683 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29683,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29683,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__29690){
var vec__29691 = p__29690;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29691,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29691,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__29706,existing_count){
var vec__29707 = p__29706;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29707,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29707,(1),null);
...
return cljs.core.filterv((function (p1__29701_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__29701_SHARP_))));
...
var vec__29741 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29741,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29741,(1),null);
var cvec_element = vec__29741;
if((cvec_element == null)){
var G__29819 = cljs.core.next(cvec_nl);
var G__29820 = (idx + (1));
var G__29821 = start;
var G__29822 = out;
cvec_nl = G__29819;
...
var G__29823 = cljs.core.next(cvec_nl);
var G__29824 = (idx + (1));
var G__29825 = idx;
var G__29826 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__29823;
idx = G__29824;
start = G__29825;
out = G__29826;
...
var G__29827 = cljs.core.next(cvec_nl);
var G__29828 = (idx + (1));
var G__29829 = (idx + (1));
var G__29830 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__29827;
idx = G__29828;
start = G__29829;
out = G__29830;
...
var G__29831 = cljs.core.next(cvec_nl);
var G__29832 = (idx + (1));
var G__29833 = idx;
...
var G__29836 = cljs.core.next(cvec_nl);
var G__29837 = (idx + (1));
var G__29838 = start;
var G__29839 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__29836;
idx = G__29837;
start = G__29838;
out = G__29839;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__29754_SHARP_,p2__29753_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__29753_SHARP_)){
return cljs.core.reduced(p1__29754_SHARP_);
} else {
return (p1__29754_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__29765,p__29766){
var vec__29767 = p__29765;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29767,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29767,(1),null);
var vec__29770 = p__29766;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29770,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29770,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__29777,cvec,focus_vec){
...
var options = map__29778__$1;
var map__29779 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29778__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29779__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29779__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29779__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29776_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__29776_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
