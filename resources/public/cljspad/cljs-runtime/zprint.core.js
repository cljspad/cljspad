...
var vec__34352 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__34355 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34355,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34355,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34352,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34352,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__34363){
var vec__34364 = p__34363;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34364,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34364,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34370,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34370,(1),null);
...
var vec__34377 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34377,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34377,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34377,(2),null);
var vec__34380 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34380,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34380,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34380,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__34384){
var vec__34385 = p__34384;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34385,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34385,(1),null);
...
var len__4736__auto___34434 = arguments.length;
var i__4737__auto___34435 = (0);
while(true){
if((i__4737__auto___34435 < len__4736__auto___34434)){
args__4742__auto__.push((arguments[i__4737__auto___34435]));

var G__34436 = (i__4737__auto___34435 + (1));
i__4737__auto___34435 = G__34436;
continue;
} else {
}
break;
...
var vec__34391 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34391,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34391,(1),null);
...
var G__34394 = zprint.core.parse_string_all_options(rest_options);
var G__34395 = zprint.core.zprint_str_internal;
var G__34396 = ":parse-string-all? call";
var G__34397 = (function (){var G__34398 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__34398) : zprint.zutil.edn_STAR_.call(null,G__34398));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__34394,G__34395,G__34396,G__34397) : zprint.core.process_multiple_forms.call(null,G__34394,G__34395,G__34396,G__34397));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__34399 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34399,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34399,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq34388){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34389,G__34390,seq34388__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq34410){
var G__34411 = cljs.core.first(seq34410);
var seq34410__$1 = cljs.core.next(seq34410);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34411,seq34410__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq34412){
var G__34413 = cljs.core.first(seq34412);
var seq34412__$1 = cljs.core.next(seq34412);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34413,seq34412__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___34444 = arguments.length;
var i__4737__auto___34445 = (0);
while(true){
if((i__4737__auto___34445 < len__4736__auto___34444)){
args__4742__auto__.push((arguments[i__4737__auto___34445]));

var G__34446 = (i__4737__auto___34445 + (1));
i__4737__auto___34445 = G__34446;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq34414){
var G__34415 = cljs.core.first(seq34414);
var seq34414__$1 = cljs.core.next(seq34414);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34415,seq34414__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq34416){
var G__34417 = cljs.core.first(seq34416);
var seq34416__$1 = cljs.core.next(seq34416);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34417,seq34416__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__34419,form){
var vec__34420 = p__34419;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34420,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34420,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34420,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34420,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__34423 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34423,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34423,(1),null);
...
var forms = (function (){var G__34428 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__34428) : zprint.zutil.edn_STAR_.call(null,G__34428));
})();
