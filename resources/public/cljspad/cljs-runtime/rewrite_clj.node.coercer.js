...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__32678 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
...
var comma_32686 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_32687 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__32679){
var vec__32680 = p__32679;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32680,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32680,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_32687,rewrite_clj.node.protocols.coerce(v),comma_32686], null);
