...
var G__29607 = (function (){var and__4115__auto__ = (function (){var or__4126__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,new cljs.core.Keyword(null,"left","left",-399115937));
if(or__4126__auto__){
...
var G__29608 = new_next_nonws_QMARK_;
index = G__29606;
skip_to_right_QMARK_ = G__29607;
next_nonws_QMARK_ = G__29608;
continue;
}
}
break;
...
var G__29610 = zprint.focus.next_ssv(ssv,index);
var G__29611 = (moves - (1));
index = G__29610;
moves = G__29611;
continue;
}
...
var G__29612 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__29613 = cljs.core.next(nwp);
idx = G__29612;
nwp = G__29613;
continue;
}
