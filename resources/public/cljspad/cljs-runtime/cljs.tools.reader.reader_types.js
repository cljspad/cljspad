...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_23900 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_23900(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_23915 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_23915(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23923 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23923(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23956 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23956(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23962 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23962(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23964 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23964(reader);
}
});
...
var G__24168 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__24169 = s.append(c);
c = G__24168;
s = G__24169;
continue;
}
