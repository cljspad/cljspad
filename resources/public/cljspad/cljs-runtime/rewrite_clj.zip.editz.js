...
var G__32926 = (function (){var G__32927 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__32927) : f.call(null,G__32927));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__32926) : rewrite_clj.node.coerce.call(null,G__32926));
});
/**
...
var len__4736__auto___32953 = arguments.length;
var i__4737__auto___32954 = (0);
while(true){
if((i__4737__auto___32954 < len__4736__auto___32953)){
args__4742__auto__.push((arguments[i__4737__auto___32954]));

var G__32955 = (i__4737__auto___32954 + (1));
i__4737__auto___32954 = G__32955;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__32928_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__32928_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq32929){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32930,G__32931,seq32929__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__32944 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__32944) : str_fn.call(null,G__32944));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__32945 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__32945) : str_fn.call(null,G__32945));
})()):null)));
...
var G__32950 = rewrite_clj.zip.base.tag(zloc);
var G__32950__$1 = (((G__32950 instanceof cljs.core.Keyword))?G__32950.fqn:null);
switch (G__32950__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__32948_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__32948_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__32949_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__32949_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32950__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__32952 = rewrite_clj.zip.base.tag(zloc);
var G__32952__$1 = (((G__32952 instanceof cljs.core.Keyword))?G__32952.fqn:null);
switch (G__32952__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__32951_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__32951_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32952__$1)].join('')));
